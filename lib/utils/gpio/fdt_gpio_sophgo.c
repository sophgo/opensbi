...
#define SOPHGO_GPIO_STARTUP_FLAG	SOPHGO_GPIO_BIT(11)
...
static int sophgo_gpio_addr_get(const void *fdt, int nodeoff, unsigned long *addr)
{
	int parent, len;
...
static int sophgo_gpio_init(const void *fdt, int nodeoff,
